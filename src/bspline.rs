...
pub fn sinc_kernel_matrix(knots: &[f64], degree: usize, q: &[f64]) -> DMatrix<f64> {
    let n_basis = knots.len() - degree - 1;
    let n_q = q.len();
    DMatrix::from_fn(n_q, n_basis, |i, j| {
        integrate_basis_sinc(knots, degree, j, q[i])
    })
}
...
mod tests {
    ...
    fn kernel_q0_exact() {
        ...
        let expected: Vec<f64> = fracs
            .iter()
            .map(|&f| 4.0 * std::f64::consts::PI * span * f)
            .collect();
    ...
    fn kernel_matches_python_reference() {
        ...
        let cases = [
            Case {
                q: 0.00,
                j: 0,
                expected: 39.269_908_169_9,
            },
            Case {
                q: 0.00,
                j: 3,
                expected: 157.079_632_679_5,
            },
            Case {
                q: 0.05,
                j: 0,
                expected: 39.100_177_000_4,
            },
            Case {
                q: 0.05,
                j: 3,
                expected: 117.328_635_484_0,
            },
            Case {
                q: 0.05,
                j: 6,
                expected: 11.481_906_632_6,
            },
            Case {
                q: 0.20,
                j: 0,
                expected: 36.716_716_170_4,
            },
            Case {
                q: 0.20,
                j: 1,
                expected: 49.687_860_411_5,
            },
            Case {
                q: 0.20,
                j: 3,
                expected: -9.820_720_300_5,
            },
        ];
    ...
    fn kernel_saxs_realistic() {
        ...
        let cases = [
            Case {
                q: 0.01,
                j: 1,
                expected: 49.580_055_334_037,
            },
            Case {
                q: 0.01,
                j: 5,
                expected: 97.534_180_650_444,
            },
            Case {
                q: 0.01,
                j: 10,
                expected: 91.039_585_896_515,
            },
            Case {
                q: 0.01,
                j: 15,
                expected: 80.185_120_765_809,
            },
            Case {
                q: 0.01,
                j: 20,
                expected: 33.907_173_341_474,
            },
            Case {
                q: 0.05,
                j: 1,
                expected: 49.007_359_019_168,
            },
            Case {
                q: 0.05,
                j: 5,
                expected: 62.525_370_712_647,
            },
            Case {
                q: 0.05,
                j: 10,
                expected: -10.545_006_180_078,
            },
            Case {
                q: 0.05,
                j: 15,
                expected: -12.150_265_783_268,
            },
            Case {
                q: 0.05,
                j: 20,
                expected: 5.618_214_405_505,
            },
            Case {
                q: 0.10,
                j: 1,
                expected: 47.269_157_112_391,
            },
            Case {
                q: 0.10,
                j: 5,
                expected: 1.521_585_125_864,
            },
            Case {
                q: 0.10,
                j: 10,
                expected: 8.989_943_956_808,
            },
            Case {
                q: 0.10,
                j: 15,
                expected: -8.092_895_280_745,
            },
            Case {
                q: 0.10,
                j: 20,
                expected: 3.059_657_454_506,
            },
            Case {
                q: 0.20,
                j: 1,
                expected: 41.036_368_068_609,
            },
            Case {
                q: 0.20,
                j: 5,
                expected: -1.142_643_055_737,
            },
            Case {
                q: 0.20,
                j: 10,
                expected: 4.579_071_684_723,
            },
            Case {
                q: 0.20,
                j: 15,
                expected: -0.219_487_613_798,
            },
            Case {
                q: 0.20,
                j: 20,
                expected: -1.053_004_682_761,
            },
            Case {
                q: 0.30,
                j: 1,
                expected: 32.798_671_738_670,
            },
            Case {
                q: 0.30,
                j: 5,
                expected: 0.693_172_051_204,
            },
            Case {
                q: 0.30,
                j: 10,
                expected: 1.217_376_527_762,
            },
            Case {
                q: 0.30,
                j: 15,
                expected: 1.113_416_898_118,
            },
            Case {
                q: 0.30,
                j: 20,
                expected: -0.303_154_238_063,
            },
            Case {
                q: 0.50,
                j: 1,
                expected: 17.834_970_078_671,
            },
            Case {
                q: 0.50,
                j: 5,
                expected: 0.107_511_372_034,
            },
            Case {
                q: 0.50,
                j: 10,
                expected: -0.089_906_179_010,
            },
            Case {
                q: 0.50,
                j: 15,
                expected: -0.083_391_987_927,
            },
            Case {
                q: 0.50,
                j: 20,
                expected: -0.168_592_160_282,
            },
        ];
